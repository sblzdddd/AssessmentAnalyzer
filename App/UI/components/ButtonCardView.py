...
from qfluentwidgets import IconWidget, CardWidget, SmoothScrollArea
from App.UI.stylesheet import StyleSheet
from PyQt5.QtWidgets import QSizePolicy


class SubjectCard(CardWidget):
    """ Clickable Subject Card Component """
...
class CardList(QWidget):
    ...
    def addCard(self, icon, title, content, action):
        """ Add subject card """
        card = SubjectCard(icon, title, content, action, self)
